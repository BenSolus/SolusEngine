...
vk::eng::SwapChain::SwapChain(SharedPtrLogicalDevice const& device,
    ...
    mDevice(device)
{
  ...
  if(vkCreateSwapchainKHR(vkDevice, &createInfo, nullptr, &mSwapChain) != VK_SUCCESS)
  {
    cc::throw_with_nested<std::runtime_error>("failed to create swap chain!",
                                              PRETTY_FUNCTION_SIG);
  }
...
vk::eng::SwapChain::~SwapChain() noexcept
{
  destroyMembers();
}

VkSurfaceFormatKHR
vk::eng::SwapChain::chooseSwapSurfaceFormat
...
VkPresentModeKHR
vk::eng::SwapChain::chooseSwapPresentMode
...
VkExtent2D
vk::eng::SwapChain::chooseSwapExtent
...
void
vk::eng::SwapChain::destroyMembers()
{
